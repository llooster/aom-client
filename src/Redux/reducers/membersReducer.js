...
const initMembersState = {
    originMembers: [
        ...
        { id: 2, lessons: ["swimming"], name: "Cersei", age: 42 },
        { id: 3, lessons: ["swimming"], name: "Jaime", age: 45 },
        { id: 4, lessons: ["baseball"], name: "Arya", age: 16 },
        { id: 5, lessons: ["baseball"], name: "Daenerys", age: 80 },
        { id: 6, lessons: ["baseball"], name: "null", age: 150 },
        { id: 7, lessons: ["Jiu-Jitsu"], name: "Ferrara", age: 44 },
        { id: 8, lessons: ["Jiu-Jitsu"], name: "Rossini", age: 36 },
        { id: 9, lessons: ["Jiu-Jitsu"], name: "Harvey", age: 65 },
        { id: 10, lessons: ["Jiu-Jitsu"], name: "Harvey1", age: 6 },
