export const INIT_FORM              = "lessons/INIT_FORM";
export const UPDATE_LESSON_NAME     = "lessons/UPDATE_LESSON_NAME";
export const UPDATE_LESSON_DAY     = "lessons/UPDATE_LESSON_DAY";
